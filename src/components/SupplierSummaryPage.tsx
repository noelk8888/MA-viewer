...
import { fetchSummaryData, fetchSupplierMonthSummaries, type SummaryData, type SupplierMonthSummary } from '../services/googleSheetsService';
...
}> = ({ onBack, cutoffDate, onCutoffDateChange, onMonthClick, onSpecialClick }) => {
